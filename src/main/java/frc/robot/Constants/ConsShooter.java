...
public final class ConsShooter {
    ...
    public static final double FLYWHEEL_FORWARD_VOLTS = 0.5;
    public static final double FLYWHEEL_REVERSE_VOLTS = -0.5;
    public static final double FLYWHEEL_STOP_VOLTS = 0.0;

    public static final double INTAKE_FORWARD = -0.6;
    public static final double INTAKE_REVERSE = 0.8;

    public static final double SHOOTER_TRAIN_FORWARD = -0.85;
    public static final double SHOOTER_TRAIN_REVERSE = 0.8;
    public static final double UPTAKE_REVERSE_VOLTAGE = 2.0;

    public static final double FEED_INTAKE_FORWARD = -0.6;
    public static final double FEED_SHOOTER_FORWARD = 0.7;
    public static final double FEED_INTAKE_REVERSE = 0.7;
    public static final double FEED_SHOOTER_REVERSE = -0.8;
